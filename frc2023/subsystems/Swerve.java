...
public class Swerve extends Subsystem {
    ...
    public SwerveModulePosition[] swerveModulePosition = new SwerveModulePosition[] {
    ...
    public Swerve() {        
        swerveOdometry = new SwerveDriveOdometry(Constants.SwerveConstants.swerveKinematics, mPigeon.getYaw().getWPIRotation2d()
            , swerveModulePosition, new Pose2d(0, 0, new Rotation2d()));
        //Line Above changed ^
    ...
    public void resetOdometry(Pose2d pose) {
        swerveOdometry.resetPosition(pose.getRotation(), swerveModulePosition , pose);
    ...
    public SwerveModulePosition[] getPositions() {
        ...
        for(SwerveModule mod : mSwerveMods){
            ...
            SmartDashboard.putNumber("mod " + mod.moduleNumber + " current angle", MathUtil.inputModulus(positions[mod.moduleNumber].angle.getDegrees(), 0, 180));
        }
        return positions;
    }
